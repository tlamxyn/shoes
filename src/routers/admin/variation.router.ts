...
variation_router.get('/:variation_id',
    Authorization(Role.Administrator, [{ Table: Table.variation, CRUD: CRUD.OnlyRead }]),
    Validate(VariationSchema.Name.GetOneVariationSchema),
...
variation_router.post('/',
    ...
    Validate(VariationSchema.Name.CreateVariationSchema),
...
variation_router.put('/:variation_id',
    ...
    Validate(VariationSchema.Name.UpdateVariationSchema),
...
variation_router.delete('/:variation_id',
    ...
    Validate(VariationSchema.Name.DeleteVariationSchema),
